...
function buildRegionalWordSeeds() {
  const sourceIdsForWords = [sourceIds.regionalWords];
  const items = [
    ["biloute", "Biloute", "Mot affectueux du parler populaire du Nord.", ["vocabulaire", "parler-regional"]],
    ["drache", "Drache", "Grosse pluie, souvent employee pour une averse bien marquee.", ["meteo", "parler-regional"]],
    ["chicon", "Chicon", "Nom regional courant de l'endive.", ["gastronomie", "legume"]],
    ["quinquin", "Quinquin", "Petit enfant dans le parler regional.", ["famille", "parler-regional"]],
    ["ducasse", "Ducasse", "Fete populaire locale, souvent associee aux maneges.", ["tradition", "fete"]],
    ["baraque", "Baraque", "Stand ou petite installation de vente, frequent dans le vocabulaire de fete ou de marche.", ["quotidien", "marche"]],
    ["braderie", "Braderie", "Grande vente populaire, particulierement associee a Lille.", ["lille", "evenement"]],
    ["estaminet", "Estaminet", "Cafe ou lieu convivial traditionnel du Nord et de Flandre.", ["sortie", "tradition"]],
    ["welsh", "Welsh", "Plat de brasserie tres present dans le Nord, a base de fromage fondu.", ["gastronomie", "plat"]],
    ["carbonnade", "Carbonnade", "Plat mijote au boeuf, souvent associe aux tables du Nord.", ["gastronomie", "plat"]],
    ["potjevleesch", "Potjevleesch", "Specialite froide en gelee, typique de la tradition flamande regionale.", ["gastronomie", "plat"]],
    ["merveilleux", "Merveilleux", "Dessert a base de meringue et de creme, tres associe au Nord.", ["gastronomie", "dessert"]],
    ["maroilles", "Maroilles", "Fromage du Nord au caractere bien identifiable.", ["gastronomie", "fromage"]],
    ["genievre", "Genièvre", "Eau-de-vie traditionnelle du Nord.", ["gastronomie", "boisson"]],
    ["cassonade", "Cassonade", "Sucre roux utilise dans plusieurs douceurs regionales.", ["gastronomie", "sucre"]],
    ["speculoos", "Speculoos", "Biscuit epice tres present dans le Nord et la Belgique voisine.", ["gastronomie", "dessert"]],
    ["babelutte", "Babelutte", "Confiserie dure au caramel connue dans le Nord.", ["gastronomie", "confiserie"]],
    ["flamiche", "Flamiche", "Tarte salee regionale, souvent associee au poireau ou au fromage.", ["gastronomie", "plat"]],
    ["waterzoi", "Waterzoï", "Plat flamand mijote, souvent au poisson ou a la volaille.", ["gastronomie", "plat"]],
    ["houblon", "Houblon", "Plante associee aux traditions brassicoles du Nord.", ["gastronomie", "biere"]],
    ["brassin", "Brassin", "Cuvee ou production de biere, utile pour un angle brassicole non marque.", ["gastronomie", "biere"]],
    ["carnaval", "Carnaval", "Fete populaire majeure dans plusieurs villes du Nord.", ["tradition", "fete"]],
    ["beffroi", "Beffroi", "Tour civile emblematique de nombreuses villes du Nord.", ["patrimoine", "architecture"]],
    ["friterie", "Friterie", "Lieu de restauration populaire autour des frites.", ["gastronomie", "quotidien"]],
  ].map(([id, label, definition, themes]) => ({
    id,
    label,
