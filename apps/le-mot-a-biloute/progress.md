...
- Itération validation 26.06.02.1 : ajout d'un dictionnaire français large `french-guesses.json` généré depuis `wordle-fr-main/mots.txt` de LouanBen/wordle-fr, utilisé uniquement pour accepter les propositions et séparé des réponses du jour. Le dossier temporaire `wordle-fr-main/` est ignoré.
